...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.rainbow, f'            TIKTOK: @{__TIKTOK_NAME__} or @{__TIKTOK_USER__}'))
    print(Colorate.Horizontal(Colors.rainbow, '=================================================================='))
    ...
    while True:
        ...
        while True:
            ...
            menu_price_list = [
                ...
                ("{04}: Change ID                     ", "100"),
                ("{05}: Change Name                   ", "100"),
                ("{06}: Change Name (rainbow)         ", "2K"),
                ("{07}: Number Plates                 ", "Free"),
                ("{08}: Account Delete                ", "Free"),
                ("{09}: Account Register              ", "500"),
                ("{10}: Delete Friends                ", "5K"),
                ("{11}: Unlock All Paid Cars          ", "6K"),
                ("{12}: Unlock All Cars               ", "3.5K"),
                ("{13}: Unlock All Cars Siren         ", "4K"),
                ("{14}: Unlock W16 Engine             ", "3K"),
                ("{15}: Unlock All Horns              ", "3K"),
                ("{16}: Unlock Disable Damage         ", "3K"),
                ("{17}: Unlock Unlimited Fuel         ", "4K"),
                ("{18}: Unlock Home 3                 ", "4K"),
                ("{19}: Unlock Smoke                  ", "4K"),
                ("{20}: Unlock Wheels                 ", "2K"),
                ("{21}: Unlock Animations             ", "2K"),
                ("{22}: Unlock Equipaments M          ", "2K"),
                ("{23}: Unlock Equipaments F          ", "1K"),
                ("{24}: Change Race Wins              ", "1K"),
                ("{25}: Change Race Loses             ", "7K"),
                ("{26}: Clone Account                 ", "2.5K"),
                ("{27}: Custom HP                     ", "1.5K"),
